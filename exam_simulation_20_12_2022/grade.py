...
if not os.path.isfile('program.py'):
    print('WARNING: Save program.py as program.py\n'
...
def test_func1_2():
    ...
    expected = ['The', 'John', 'Paul', 'Ringo', 'George', 'Starr.', 'Beatles', 'English', 'Lennon,', 'Harrison',
                'Liverpool', 'McCartney,']
    return do_func1_tests(string_list, expected)
...
def test_func2_2():
    ...
    expected = {'ringo': {'starr'}, 'John': {'Lennon'}, 'Paul': {'McCartney'}, 'George': {'Harrison'},
                'Ringo': {'Starr'}}
    return do_func2_tests(pathname, expected)
...
def test_ex2_2():
    ...
    strings = {'p', 'ro', 'gra', 'mmin', 'Python'}
    n = 3
    expected = ['Pythongrammin', 'Pythonmmingra', 'graPythonmmin', 'gramminPython', 'mminPythongra', 'mmingraPython',
                'Pythonmminro', 'Pythonrommin', 'mminPythonro', 'mminroPython', 'roPythonmmin', 'romminPython',
                'Pythongraro', 'Pythonmminp', 'Pythonpmmin', 'Pythonrogra', 'graPythonro', 'graroPython', 'mminPythonp',
                'mminpPython', 'pPythonmmin', 'pmminPython', 'roPythongra', 'rograPython', 'Pythongrap', 'Pythonpgra',
                'graPythonp', 'grapPython', 'pPythongra', 'pgraPython', 'Pythonpro', 'Pythonrop', 'gramminro',
                'grarommin', 'mmingraro', 'mminrogra', 'pPythonro', 'proPython', 'roPythonp', 'rogrammin', 'rommingra',
                'ropPython', 'gramminp', 'grapmmin', 'mmingrap', 'mminpgra', 'pgrammin', 'pmmingra', 'mminpro',
                'mminrop', 'pmminro', 'prommin', 'romminp', 'ropmmin', 'grapro', 'grarop', 'pgraro', 'progra', 'rograp',
                'ropgra']
    return do_ex2_test(strings, n, expected)
...
def test_ex2_3():
    ...
    strings = {'bim', 'bum', 'ba', 'le', 'giu'}
    n = 5
    expected = ['babimbumgiule', 'babimbumlegiu', 'babimgiubumle', 'babimgiulebum', 'babimlebumgiu', 'babimlegiubum',
                'babumbimgiule', 'babumbimlegiu', 'babumgiubimle', 'babumgiulebim', 'babumlebimgiu', 'babumlegiubim',
                'bagiubimbumle', 'bagiubimlebum', 'bagiubumbimle', 'bagiubumlebim', 'bagiulebimbum', 'bagiulebumbim',
                'balebimbumgiu', 'balebimgiubum', 'balebumbimgiu', 'balebumgiubim', 'balegiubimbum', 'balegiubumbim',
                'bimbabumgiule', 'bimbabumlegiu', 'bimbagiubumle', 'bimbagiulebum', 'bimbalebumgiu', 'bimbalegiubum',
                'bimbumbagiule', 'bimbumbalegiu', 'bimbumgiubale', 'bimbumgiuleba', 'bimbumlebagiu', 'bimbumlegiuba',
                'bimgiubabumle', 'bimgiubalebum', 'bimgiubumbale', 'bimgiubumleba', 'bimgiulebabum', 'bimgiulebumba',
                'bimlebabumgiu', 'bimlebagiubum', 'bimlebumbagiu', 'bimlebumgiuba', 'bimlegiubabum', 'bimlegiubumba',
                'bumbabimgiule', 'bumbabimlegiu', 'bumbagiubimle', 'bumbagiulebim', 'bumbalebimgiu', 'bumbalegiubim',
                'bumbimbagiule', 'bumbimbalegiu', 'bumbimgiubale', 'bumbimgiuleba', 'bumbimlebagiu', 'bumbimlegiuba',
                'bumgiubabimle', 'bumgiubalebim', 'bumgiubimbale', 'bumgiubimleba', 'bumgiulebabim', 'bumgiulebimba',
                'bumlebabimgiu', 'bumlebagiubim', 'bumlebimbagiu', 'bumlebimgiuba', 'bumlegiubabim', 'bumlegiubimba',
                'giubabimbumle', 'giubabimlebum', 'giubabumbimle', 'giubabumlebim', 'giubalebimbum', 'giubalebumbim',
                'giubimbabumle', 'giubimbalebum', 'giubimbumbale', 'giubimbumleba', 'giubimlebabum', 'giubimlebumba',
                'giubumbabimle', 'giubumbalebim', 'giubumbimbale', 'giubumbimleba', 'giubumlebabim', 'giubumlebimba',
                'giulebabimbum', 'giulebabumbim', 'giulebimbabum', 'giulebimbumba', 'giulebumbabim', 'giulebumbimba',
                'lebabimbumgiu', 'lebabimgiubum', 'lebabumbimgiu', 'lebabumgiubim', 'lebagiubimbum', 'lebagiubumbim',
                'lebimbabumgiu', 'lebimbagiubum', 'lebimbumbagiu', 'lebimbumgiuba', 'lebimgiubabum', 'lebimgiubumba',
                'lebumbabimgiu', 'lebumbagiubim', 'lebumbimbagiu', 'lebumbimgiuba', 'lebumgiubabim', 'lebumgiubimba',
                'legiubabimbum', 'legiubabumbim', 'legiubimbabum', 'legiubimbumba', 'legiubumbabim', 'legiubumbimba']
...
if __name__ == '__main__':
    ...
    BOLD = '\033[1m'
    print(
        f"Three func problems solved:  {BOLD} {COL['GREEN'] if constraint1 else COL['RED']} {constraint1}{COL['RST']}{ENDC}")
    print(
        f"One ex problem solved:       {BOLD} {COL['GREEN'] if constraint2 else COL['RED']} {constraint2}{COL['RST']} ")
    print(
        f"Total > 18:                  {BOLD} {COL['GREEN'] if constraint3 else COL['RED']} {constraint3}{COL['RST']}{ENDC}")
    print(
        f"Exam passed:                 {BOLD} {COL['GREEN'] if constraint4 else COL['RED']} {constraint4}{COL['RST']}{ENDC}")
################################################################################
